...
// import type { loader } from '~/routes/order.$status';
// import { useEffect, useState } from 'react';

// export default function CardCenceledNew() {
...
//   const [searchFilter2, setSearchFilter2] = useState<string>('computer');
//   const [courierFilter, setCourierFilter] = useState<Array<string>>(['jne']);
...
//   // const searchTerm = cardProduct.searchTerm;
//   // const cancel = cardProduct.canceledService;
//   // console.log("cancel", cancel);

//   useEffect(() => {
//     if (searchFilter2 || courierFilter || sortFilter) {
//       submit({ searchFilter2, courierFilter, sortFilter }, { method: 'GET' });
//     }
//   }, [searchFilter2, courierFilter, sortFilter]);
