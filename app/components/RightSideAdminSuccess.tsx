...
export default function RightSideAdminSuccess() {
  return (
    <>
      <Box
        // bg={"yellow.300"}
        ...
        <Box mt={'10px'}>
          ...
          <UnorderedList>
            ...
            <ListItem>
              ...
              <ListItem ml={'20px'}>6 September 2023 pukul 15:00</ListItem>
            </ListItem>

            <ListItem>
              Permintaan dibuat
              <ListItem ml={'20px'}>6 September 2023 pukul 14:55</ListItem>
            </ListItem>
          </UnorderedList>
        </Box>
      </Box>
