...
export function AdminDeclinedNotification(reasonAdminDeclined: string) {
  ...
  const params: IDroppingOff = {
    ...
    fields: {
      ...
      reasonadmindeclined: { reasonAdminDeclined },
      // We must add field first in our MailerLite dashboard for it to work
    },
    groups: ['99632857612289589'], // This is where you need to categorize which group it should go for email automation trigger
