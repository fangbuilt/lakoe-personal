...
export function WithdrawNotification(amount: string, bankAccount: string) {
  const params: IDroppingOff = {
    email: 'muhammadalisyamsi+feffsfdtswee@gmail.com', // The receiver email's - We will get the email from table invoice userId relation to get the email
    fields: {
    ...
    groups: ['99072030037509920'], // This is where you need to categorize which group it should go for email automation trigger
